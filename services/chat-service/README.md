...
Stateless сервис на Python (FastAPI) для координации агентов через обмен информационными сообщениями. Использует Redis Streams для хранения последних 1000 сообщений.
