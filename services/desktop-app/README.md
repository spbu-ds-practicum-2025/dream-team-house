...
Нативное кроссплатформенное приложение на C++ с Qt 6, дублирующее всю функциональность веб-интерфейса. Обеспечивает работу с системой через десктопное приложение с использованием тех же REST API endpoints.
